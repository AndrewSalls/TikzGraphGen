...
namespace TikzGraphGen.Visualization
{
    ...
    {
        public static readonly int NUMBER_TOOLBAR_ITEMS = 10;
        ...
        public void Initialize()
        {
            ...
            items[4] = GenerateButton("Transform", Resources.TransformIcon, (o, e) => _rsc.CurrentTool = SelectedTool.Transform);
            items[5] = GenerateButton("Select", Resources.SelectIcon, (o, e) => _rsc.CurrentTool = SelectedTool.Select);
            items[6] = GenerateButton("Weight", Resources.WeightIcon, (o, e) => _rsc.CurrentTool = SelectedTool.Weight);
            items[7] = GenerateButton("Tracker", Resources.TrackerIcon, (o, e) => _rsc.CurrentTool = SelectedTool.Tracker);
            items[8] = GenerateButton("Merge", Resources.MergeIcon, (o, e) => _rsc.CurrentTool = SelectedTool.Merge);
            items[9] = GenerateButton("Split", Resources.SplitIcon, (o, e) => _rsc.CurrentTool = SelectedTool.Split);
