...
namespace TikzGraphGen
{
    public class VertexBorderStyle
    {
        ...
        public VertexBorderStyle(BorderStyle style, Color foreColor, Color fillColor, float thick, float rad)
        {
            ...
            _vertexInfo.BorderColor = foreColor;
            _vertexInfo.FillColor = fillColor;
        ...
        public VertexBorderStyle(BorderStyle style, Color foreColor, Color fillColor, float thick, float rad, int polys)
        {
        ...
        public VertexBorderStyle(BorderStyle style, Color foreColor, Color fillColor, float thick, float width, float height)
        {
